...
that a uniform field is constant in a homogeneous, uniform universe
and is also the quantity used in the MHD-Dedner solver described
below; however, it is not universal,
and in particular is slightly different from that used both in \citet{Li08a}
and that used in the MHD-CT solver.

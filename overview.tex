...
\frac{\partial \rho \vecv}{\partial t}  
   + \frac{1}{a} \nabla \cdot \left(\rho \vecv \vecv + \myvec{I} p - \vecB \vecB \right) & = &
...
%          - \frac{1}{a} \nabla \phi, 
        \label{eq:momentum} \\
%
\frac{\partial E \rho}{\partial t} 
+ \frac{1}{a} \nabla \cdot \left[ (E + p) \vecv - (\vecB \cdot \vecv) \vecB \right] & = &
     - \frac{2\dot{a}}{a} E - \frac{1}{a} \vecv \cdot \nabla \phi + \frac{\dot{a}}{a} \frac{\vecB \cdot \vecB}{2}
%
%         + \frac{1}{a} \vecv \cdot \nabla E
...
%
\frac{\partial \vecB}{\partial t} & = & \frac{1}{a}  \nabla \times (\vecv \times \vecB) - \frac{\dot{a}}{2a} \vecB \label{eq:induction}
\end{eqnarray}
...
%\end{eqnarray}
%
Here $E$, $e$, $\rho$, $\vecv$, $\vecB$, and $p$ are the comoving total fluid energy, specific thermal energy, baryonic density, velocity, magnetic field strength and pressure, respectively.  $I$ is the identify matrix and we use a set of units for the magnetic field such that magnetic xxx is unity.
...
\begin{equation}
E =  e + \frac{1}{2} \vecv \cdot \vecv + \vecB \cdot \vecB

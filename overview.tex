...
As an alternative to the ray-casting strategy, we solve an equation derived from integrating
...
linear momentum, and energy.  \red{(REF?)}  A variety of reconstruction methods and
Riemann solvers have been implemented.  \red{(These are never described!)}

...
\frac{\partial \rho \vecv}{\partial t}  
   + \frac{1}{a} \nabla \cdot \left(\rho \vecv \vecv + p^* - \vecB \vecB \right) & = &
...
+ \frac{1}{a} \nabla \cdot \left[ (E + p^*) \vecv -  \vecB (\vecB \cdot \vecv) \right] & = &
     - \frac{\dot{a}}{a} \left( 2E - \frac{\vecB^2}{2} \right)  - \frac{1}{a} \vecv \cdot \nabla \phi 
     %
%         + \frac{1}{a} \vecv \cdot \nabla E
...
\vecB & = & a^2 \vecB^\prime
\end{eqnarray}
where primes indicate the usual proper quantities.

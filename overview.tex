...
\frac{\partial \rho \vecv}{\partial t}  
   + \frac{1}{a} \nabla \cdot \left(\rho \vecv \vecv + p^* - \vecB \vecB) =
    - \frac{\dot{a}}{a} rho \vecB - \frac{1}{a} \rho \nabla \phi
    %
%          + \frac{1}{a} ( \vecv \cdot \nabla ) \vecv
%    & = & - \frac{\dot{a}}{a} \vecv 
%          - \frac{1}{a \rho} \nabla p
...
+ \frac{1}{a} \nabla \cdot \left[ (E + p^*) \vecv - (\vecB \cdot \vecv) \vecB \right] =
     - \frac{2\dot{a}}{a} E - \frac{1}{a} \vecv \cdot \nabla \phi + \frac{\dot{a}}{a} \frac{\vecB^2}{2}
...
%
\frac{\partial \vecB}{\partial t} = \frac{1}{a}  \nabla \times (\vecc \times \vecB) - \frac{dot{a}{2a} \vecB \label{eq:induction}

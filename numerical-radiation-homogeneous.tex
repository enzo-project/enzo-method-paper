...
\red{Note: we talk about several radiation field types that are not in
Table~\ref{table:homo_coefs} (4...14).  Do we want to increase the
length of the table, remove the text from the section, or perhaps just
say something in this section about how the table is for illustrative purposes? }

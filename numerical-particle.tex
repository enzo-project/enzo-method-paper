...
% The code needs to be able to model collisionless matter.  One way
% would be to model the dark matter (or other collisionless
% particle-like objects, such as stars) as a second fluid in addition to
% the baryonic fluid and solve the collisionless Boltzmann equation,
% which follows the evolution of the fluid density in six-dimensional
% phase space.  However, this is computationally prohibitive owing to
% the large dimensionality of the problem, making this approach
...
governs the maximum level at which particles will be regarded at point masses.

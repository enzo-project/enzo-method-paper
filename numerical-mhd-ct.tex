...
III stars \citep{Xu08}, molecular clouds \citep{collins12}, and galaxy clusters
...
previous time steps must be included in the interpolation, making the
...
alternative energy is used.  As in \citet{Li08}, we use $\eta=0.008$.

...
density $n_{\rm H} = 0.04\ \cubecm$ (i.e., overdensity of 200), and temperature $T = 40$ K, and
...
levels of refinement by factors of 2 for cells with a baryon mass greater than 1.5
(method 2 in Section~\ref{sec:refinement_criteria}). This test is run
for 15 Myr.

The cloud is subject to radiation from a point source at the center
...
(Note that this choice of energy groups is different from those used

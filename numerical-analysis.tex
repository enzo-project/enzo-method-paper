...
Detailed analsis of simualtion results requires both the tools to ask
...
At user-specified intervals, the tracer particles output their data.  The data written out

...
are available at \url{http://bitbucket.org/bwoshea/enzo-method-paper},
...
Section~\ref{sec.tests.compare}.  We note for completeness that all of
the figures were generated using \texttt{yt} version 2.5.3 and the
\url{https://bitbucket.org/enzo/enzo-dev} repository of \enzo\ with
changeset \texttt{5d8c412}.

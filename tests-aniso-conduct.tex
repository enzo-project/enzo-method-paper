...
\mqk{The previous paragraph more or less repeats what's in Section~\ref{sec.num.conductions}, I think it should be removed (or merged with that section).}
...
on (0.5, 0.5) in a $256 \times 256$ grid. \mqk{Maybe show some field
lines in the figure?} The background medium has a density of 1

...
\item{\em Optical depth.} This refinement criterion ensures that cells on the highest level of refinement have an \ion{H}{1} optical depth lower than unity.  The optical depth of a cell is estimated to be:

...
\begin{enumerate}
  ...
  \item{\em Outflow.} True outflow conditions are extremely difficult \red{(REF?)}.  We approximate them by duplicating the solution at the edge of the computational domain: $q(-x) = q(0)$.

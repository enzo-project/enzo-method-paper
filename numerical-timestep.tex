...
$\kappa(T)$ is the Spitzer thermal conductivity, and f$_{\rm sp}$ is a
...
$\kappa_{\rm cond}$ is a dimensionless prefactor whose
value must be $0 < \kappa_{\rm cond}  \leq 0.5$, and is exactly 0.5 for the

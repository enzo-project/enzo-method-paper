...
distance each characteristic wave can travel ($u$, $u-c$ and $u+c$).
...
\end{eqnarray}
%
This is Equation~(1.4) of CW84 (in the radial rather than mass coordinate as is appropriate for the direct rulerian approach). 

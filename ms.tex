...
is Cartesian, can be run in 1, 2, and 3 dimensions, and supports a wide
variety of physics including hydrodynamics, ideal and non-ideal
...
problems, demonstrate the code's parallel performance, and

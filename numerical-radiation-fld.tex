...
(i.e.~non-AMR, non-static mesh refinement) grids, which has been tuned for large-scale simulations
...
%  \partial_t E_r + \frac1a \div \left(E_r \myvec{v}_b\right) &=& 
...
%    \frac1a \div\left({\mathrm n}_i \myvec{v}_b\right) &=& 
...
%$E_{\nu}(\nu,\myvec{x},t) = \tilde{E}_r(\myvec{x},t) \chi(\nu)$, and then
%defining the integrated quantity
%\begin{equation}
%\label{eq:grey_radiation_energy}
%   E_r(\myvec{x},t) \equiv \int_{\nu_0}^{\infty}
%   E_{\nu}(\nu,\myvec{x},t)\,\mathrm d\nu \  = \ 
%   \tilde{E}_r(\myvec{x},t) \int_{\nu_0}^{\infty} \chi(\nu)\,\mathrm d\nu.
%\end{equation}
...
\citep[see][]{FalgoutYang2002, hypre-manual}. 

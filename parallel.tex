...
type contains no physics other than solving the equations of ideal
MHD, and thus is representative of the type of calculation than can
...
theoretical speed of 1.17 Tflops when used in double precision.  For
...
cores on each node are effectively idle, as they are used only for

...
of a cosmological simulation, when the densities are nearly uniform, only the
...
problem that is being simulated.  The top-right panel
...
case, adding more levels of refinement would substantially increase the
...
empirically tested that this scaling is approximately valid,
